...
int degree; //references the midi note
float volume; // 0-1 volume, 0 is silent and 1 is loud
float orientation; // -1 to 1 
                  
                  
PImage bird; //boid class
boolean isB1, isB2, isB3, isB4, isB5, isB6, isB7, isB8, isB9; //midicontroller class
boolean atEdge; //boid class
